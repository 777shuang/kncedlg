...
static void onInitDialog(HWND hDlg, void *params) {
    ...
    SendMessage(hFontStyleList, LB_ADDSTRING, 0, (LPARAM)_T("標準"));
    SendMessage(hFontStyleList, LB_ADDSTRING, 0, (LPARAM)_T("斜体"));
    SendMessage(hFontStyleList, LB_ADDSTRING, 0, (LPARAM)_T("太字"));
    SendMessage(hFontStyleList, LB_ADDSTRING, 0, (LPARAM)_T("太字 斜体"));
